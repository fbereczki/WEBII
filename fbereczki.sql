...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2020. Dec 06. 11:50
...
(11, 'Béla', 'Géza', 'valami', '8cb2237d0679ca88db6464eac60da96345513964', '_1_');
...
('admin', 'Admin', '', '001', 80),
('ajax', 'Ajax', 'linkek', '010', 32),
('alapinfok', 'Alapinfók', 'elerhetoseg', '111', 40),
('belepes', 'Belépés', '', '100', 60),
('elerhetoseg', 'Elérhetőség', '', '111', 20),
('github', 'GitHub', 'linkek', '010', 31),
('javascript', 'Javascript', 'linkek', '010', 33),
('jquery', 'jQuery', 'linkek', '010', 34),
('kiegeszitesek', 'Kiegészítések', 'elerhetoseg', '011', 50),
('kilepes', 'Kilépés', '', '011', 70),
('linkek', 'Linkek', '', '010', 30),
('nyitolap', 'Nyitólap', '', '111', 10),
('regisztracio', 'Regisztráció', '', '100', 61),
('restful', 'RESTful', 'linkek', '010', 35),
('soap', 'SOAP', 'linkek', '010', 36);
